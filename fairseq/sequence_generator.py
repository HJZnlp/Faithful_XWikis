...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        #print('self.tgt_dict.bos()', self.tgt_dict.bos())
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            lprobs[:, 245049]=-math.inf
            lprobs[:, 245148]=-math.inf
...
class EnsembleModel(nn.Module):
    ...
    def forward_decoder(
        ...
        # update 2022
        # if args.load_noise_labels is not None:
        noise_labels = torch.ones(tokens.shape,dtype=torch.int,device=tokens.device)
        ...
        #     noise_labels[:,:3]=1
        # else:
        #     noise_labels = torch.zeros(tokens.shape,dtype=torch.int,device=tokens.device)
        #     noise_labels[:,:3]=1
        # print(noise_labels.tolist())

        # exit()
        # noise_labels.requires_grad = False
        # noise_labels.to("cuda")
        # print(f"gen: {noise_labels.shape}")
        # print(noise_labels.shape)
        # print(tokens)
        # exit()
        ...
        for i, model in enumerate(self.models):
            ...
            if self.has_incremental_states():
                ...
                decoder_out = model.decoder.forward(tokens, encoder_out=encoder_out,noise_labels=noise_labels)
