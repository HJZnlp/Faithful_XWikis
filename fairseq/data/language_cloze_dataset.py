...
def collate(
    ...
    # need to re-process this as some orriginally masked targets have been eliminated from the
    # input by source-truncation.
    # -1 to eliminate last </s> in targets by my_preprocess, need to fix there
