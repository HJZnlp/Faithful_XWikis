...
class CountingIterator(object):
    ...
    def __init__(self, iterable, start=None, total=None):
        ...
        if total is None:
            ...
            self.total = total
        #print("Doing total PEPE's:", self.n, self.total)
...
class EpochBatchIterator(EpochBatchIterating):
    ...
    def __init__(
        ...
        #print("BATCH iterator created with ", len(list(self.frozen_batches)))
    ...
    def _get_iterator_for_epoch(self, epoch, shuffle, fix_batches_to_gpus=False, offset=0):
        ...
        if self._supports_prefetch:
            ...
            #print("going to take from", len(list(self.frozen_batches)))
            if shuffle:
            ...
            #print(self.num_shards, self.shard_id)
