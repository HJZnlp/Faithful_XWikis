...
class FairseqEncoderDecoderModel(BaseFairseqModel):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, noise_labels=None,**kwargs):
        """
        ...
        decoder_out = self.decoder(
            prev_output_tokens, encoder_out=encoder_out, noise_labels=noise_labels, **kwargs
        )
        # exit()
        return decoder_out

    def forward_decoder(self, prev_output_tokens, **kwargs):
        return self.decoder(prev_output_tokens, noise_labels,**kwargs)

    def extract_features(self, src_tokens, src_lengths, prev_output_tokens, noise_labels, **kwargs):
        """
        Similar to *forward* but only return features.
...
class FairseqMultiModel(BaseFairseqModel):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens,noise_labels, **kwargs):
        raise NotImplementedError
